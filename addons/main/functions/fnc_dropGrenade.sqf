...
[GVAR(delayInteraction) * (if (GVAR(enableKnowledgeMultiplier)) then {linearConversion [0, 4, _target knowsAbout _unit, 1, GVAR(knowledgeMultiplier)]} else {1}), [_unit, _target], QGVAR(dropGrenadeEvent), {}, LLSTRING(interactionNameProgress), {
