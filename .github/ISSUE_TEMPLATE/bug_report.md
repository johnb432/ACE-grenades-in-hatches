...
- **ACE Grenades in hatches - Tweaked:** `1.x.x` [e.g. 1.0.0 stable, commit hash]
<!-- Make sure to reproduce the issue with only CBA, ACE and ACE Grenades in hatches - Tweaked on a newly created mission! -->

**Description:**
A clear and concise description of what the bug is.

**Steps to reproduce:**
_Follow [this flowchart](https://ace3.acemod.org/img/wiki/user/issue_flowchart.webp) (Replace 'ACE3' with 'ACE Grenades in hatches - Tweaked', ignore any 'Slack' mentions)!_
